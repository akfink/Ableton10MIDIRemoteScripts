import Live
from MidiKontrolComponent import MidiKontrolComponent
from consts import *
import sys
from Devices import *
...
class MidiKontrolDeviceController(MidiKontrolComponent):
    __module__ = __name__
    __doc__ = 'Class representing the device controller section of MidiKontrol controllers'
    __filter_funcs__ = ["update_display", "log"]

    def __init__(self, parent):
	MidiKontrolDeviceController.realinit(self, parent)

    def realinit(self, parent):
	MidiKontrolComponent.realinit(self, parent)
