...
class NanoKontrol_NoPan(ControlSurface):
    ...
    def __init__(self, c_instance):
        with self.component_guard():
            ...
            self.log_message(time.strftime("%d.%m.%Y %H:%M:%S", time.localtime()) + "--------------= NanoKontrol log opened =--------------")
            # Writes message into Live's main log file. This is a ControlSurface method.
            self.log_message("AKF changes...component_guard new imports")
